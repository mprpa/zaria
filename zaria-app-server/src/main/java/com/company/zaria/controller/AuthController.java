...
import com.company.zaria.payload.JwtAuthenticationResponse;
import com.company.zaria.payload.LoginRequest;
import com.company.zaria.payload.SignUpRequest;
import com.company.zaria.repository.RoleRepository;
import com.company.zaria.repository.UserRepository;
import com.company.zaria.security.JwtTokenProvider;
...
public class AuthController {
    ...
    @PostMapping("/signuplegal")
    public ResponseEntity<?> registerUserLegal(@Valid @RequestBody SignUpRequest signUpRequest) {
        if(userRepository.existsByUsername(signUpRequest.getUsername())) {
            return new ResponseEntity(new ApiResponse(false, "Username is already taken!"),
                    HttpStatus.BAD_REQUEST);
        }
